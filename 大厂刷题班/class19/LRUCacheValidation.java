...
public class LRUCacheValidation {
    public static void main(String[] args) {
        // 创建容量为3的LRU缓存
        Code01_LRUCacheEdition1 cache = new Code01_LRUCacheEdition1(3);
    ...
    // 辅助方法：打印缓存状态
    private static void printCacheState(Code01_LRUCacheEdition1 cache) {
        // 注意：实际实现中无法直接访问内部状态
